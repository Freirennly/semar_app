<x-layouts.app :title="'Ethical Clearance'">
    {{-- Header --}}
    <div class="mb-6 animate-fade-in">
        <h2 class="text-xl font-bold text-text">Sertifikat Ethical Clearance</h2>
        <p class="text-sm text-text-secondary mt-1">Unduh Sertifikat Laik Etik resmi untuk penelitian Anda yang telah disetujui Komisi Etik.</p>
    </div>
    ...
    <div class="space-y-4 animate-slide-up">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div class="space-y-1 flex-1 min-w-0">
                        ...
                        <p class="text-xs text-text-muted flex items-center gap-1.5 pt-1">
                            ...
                            Diterbitkan pada {{ $sub->updated_at->format('d M Y') }}
                        </p>
                    </div>
                    ...
                    <div class="bg-soft-surface/60 border border-border p-4 rounded-xl flex items-center justify-between gap-6 lg:w-96 shrink-0">
                        <div class="min-w-0">
                            <h4 class="text-xs font-bold text-text uppercase tracking-wider">Sertifikat Tersedia</h4>
        ...
        @empty
            <div class="card text-center py-16 bg-white rounded-2xl border border-border shadow-sm">
                ...
                <p class="text-sm font-semibold text-text">Belum Ada Sertifikat Terbit</p>
                <p class="text-xs text-text-secondary mt-1 max-w-xs mx-auto">Sertifikat Laik Etik akan muncul di sini secara otomatis begitu pengajuan Anda dinyatakan lolos dan di-publish oleh komisi etik.</p>
            </div>
        @endforelse
    </div>
</x-layouts.app>
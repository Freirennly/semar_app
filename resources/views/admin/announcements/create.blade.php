<x-layouts.app :title="'Tambah Pengumuman'">
    <div class="mb-12 flex items-center gap-3 animate-fade-in">
        ...
        <div>
            <h1 class="text-3xl md:text-[36px] font-bold text-text tracking-tight leading-[1.3]">Tambah Pengumuman</h1>
            <p class="text-sm font-medium text-text-secondary mt-2 leading-[1.2]">Buat pengumuman baru untuk ditampilkan di sistem.</p>
        </div>
    </div>

<x-layouts.app :title="'Tambah Reviewer'">
    <div class="mb-12 flex items-center gap-3 animate-fade-in">
        ...
        <div>
            <h1 class="text-3xl md:text-[36px] font-bold text-text tracking-tight leading-[1.3]">Tambah Reviewer</h1>
            <p class="text-sm font-medium text-text-secondary mt-2 leading-[1.2]">Tambahkan akun reviewer baru ke dalam sistem.</p>
        </div>
    </div>

    <div class="card p-6 border-primary/10 shadow-sm max-w-3xl mb-12">
        <form method="POST" action="{{ route('admin.reviewers.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" required class="input-field" value="{{ old('name') }}" placeholder="Dr. Jane Doe">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required class="input-field" value="{{ old('email') }}" placeholder="jane@example.com">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="expertise" id="expertise" class="input-field" value="{{ old('expertise') }}" placeholder="Contoh: Bioetika, Keperawatan">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-border mt-6">
                ...
                <button type="submit" class="btn-primary px-8">Simpan Reviewer</button>
            </div>
        </form>
    </div>
</x-layouts.app>

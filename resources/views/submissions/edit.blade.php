                        ...
                        <div class="mt-4 pt-4 border-t border-border">
                            <div class="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-4 md:items-end">
                                ...
                                <div class="space-y-1.5">
                                    <label for="file_input_{{ $template->id }}" class="text-xs font-bold text-text uppercase tracking-wider select-none">Upload File Baru</label>
                                    <input type="file" 
                                ...
                                <div class="space-y-1.5">
                                    <label for="link_input_{{ $template->id }}" class="text-xs font-bold text-text uppercase tracking-wider select-none">Link Dokumen Baru</label>
                                    <input type="url" 

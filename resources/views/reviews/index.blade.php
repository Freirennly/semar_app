<x-layouts.app :title="'Review Saya'">
    <div class="mb-6">
        <h2 class="text-xl font-bold text-text">Review Saya</h2>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-border">
                    ...
                    <tr class="hover:bg-soft-surface/30 transition-colors">
                        ...
                        <td class="px-6 py-3"><a href="{{ route('reviews.show', $a->submission) }}" class="text-primary hover:text-primary-hover text-sm font-medium">{{ $a->status === 'COMPLETED' ? 'Lihat' : 'Isi Review' }}</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
